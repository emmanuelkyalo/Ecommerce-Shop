...
<html lang="en">
    <?php
    include 'head.php';
    $keyword = $_SESSION["brand_search_parameter"];
                    ...
                    <div id="store" class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            while ($row = mysqli_fetch_array($res)) {
                                ...
                                $percentage = ($discount / $row["price"]) * 100;
                                ?>
                                ...
                                <div class="col-md-4 col-xs-6">
                                    <div class="product">
                                        <div class="product-img">
                                            <a href="product.php?id=<?php echo $row["id"]; ?>"> <img src="admin/<?php echo $row["image"] ?>" alt="" height="270" width="250"</a>
                                            <div class="product-label">
                                                <span class="sale">- <?php echo ceil($percentage) ?>%</span>
                                             
                                            </div>
                                        </div>
                                        <div class="product-body">

                                            <h3 class="product-name"> <a href="product.php?id=<?php echo $row["id"]; ?>"><?php echo $row["name"] ?></a></h3>
                                            <h4 class="product-price">Kshs <?php echo number_format($row["price"]) ?> <del class="product-old-price">Kshs <?php echo number_format($row["price"] + $discount) ?></del></h4>

                    ...
                    <div id="store" class="col-md-9">
                        ...
                        <div class="row">
                            ...
                            while ($row = mysqli_fetch_array($res)) {
                                $discount = rand(100000, 100000000);
                                ?>
                                ...
                                <div class="col-md-4 col-xs-6">
                                    <div class="product">
                                        <div class="product-img">
                                            <a href="product.php?hash=<?php echo $discount * 3 ?>&level=<?php echo $discount ?>&id=<?php echo $row["id"]; ?>"  > <img style="text-align: center" class="img-responsive center-block"src="admin/<?php echo $row["image"] ?>" alt="" height="270" width="250"</a>
                                        ...
                                        <div class="product-body">
                                            ...
                                            <h4 class="product-price">Kshs <?php echo number_format($row["price"]) ?>  <del class="product-old-price">Kshs <?php echo number_format($row["former_price"]) ?></del> </h4>
                                            <?php if ($row["availability"] == 0) { ?>
                                             <span class=" text-warning" style=""><b>OUT OF STOCK</b></span>
